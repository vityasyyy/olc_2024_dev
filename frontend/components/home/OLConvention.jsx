  ...
  return (
    ...
    <div className="relative w-full pb-[100%] sm:mx-auto sm:h-96 sm:w-96 sm:pb-0 md:w-full md:pb-[50%]">
      <div className="absolute inset-0 flex flex-col justify-end border border-black bg-[#656161] p-4 text-white">
        {/* day label */}
        <p className="absolute left-2 top-2 mb-4 w-fit rounded-md bg-white px-4 py-1 text-sm text-black">
          Day {day}
        </p>
        ...
        {/* tanggal dan lokasi */}
        <div className="flex mt-4 flex-col gap-2 text-xs sm:flex-row sm:justify-between sm:items-center">
